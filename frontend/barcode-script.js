document.addEventListener("DOMContentLoaded", () => {
    ...
    function addBarcodeToList(barcode) {
        ...
        if (existingItem) {
            ...
            // Event-Listener, um das Listenelement anklickbar zu machen
            li.addEventListener('click', function() {
                ...
                // Hier kannst du zusätzliche Funktionen ausführen, wenn ein Element ausgewählt wird
                console.log(`${barcode} ist ausgewählt!`);
            });
